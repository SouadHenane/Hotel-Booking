...
VALUES
(1, 'souad@email.com','Souad ss', 'fffff', 'ssef', 4),
(2, 'manel@email.com','Manel fgh', 'sjd', 'manel', 2),
(3, 'houss@email.com','Hous hh', 'djfkd', 'skjfze', 1),

insert into `user` (id, email, name, password, username, authority_id) values (6, 'souad.henane95@gmail.com', 'Souad Henane', 'UKtpJgDr', 'soussou', 1);
insert into `user` (id, email, name, password, username, authority_id) values (7, 'souad.henane22@gmail.com', 'Souad Souad', 'tSOTgV', 'souadd', 3);

INSERT INTO hotel (id, address, name, rating, category_id, manager_id, status)
VALUES
(1, 'Rua vvvvv 149, SBA','Intercontinental', 5, 1, 4, true),
(2, 'Av.ssssss, SBA','Tryp', 4, 2, 4, true),
(3, 'Rua fffff, SBA','Holiday Inn', 2, 3, 5, true),
(4, 'Avenue hhhhh, SBA', 'Marriott', 5, 5, 5, false);
...
VALUES
(1, '2013-08-30 19:05:00',TRUE,'The best thing about this hotel were the owners. They were lovely friendly people.', 1, 3, false),
(2, '2017-10-18 15:10:00',TRUE,'Really helpful staff, studio room was perfect.', 1, 6, false),
(3, '2017-10-20 16:43:00',FALSE,'We loved the nice quiet location, the wonderful hospitality of the proprietor and superbly attentive staff. Breakfast always well presented and varied. Beautiful apartment with excellent facilities!', 1, 3, false),
(4, '2017-09-30 20:12:00',TRUE,'The location of the Hotel is great. Its only a view kms from the Airport, there is the great shopping centre in front of the hotel and the Metro station is next door as well.', 2, 3, false),
(5, '2017-09-30 17:55:00',TRUE,'Shower head moves all over the place. Boiler is noisy even though its in an outside cupboard its still next to the bed. Be good if the wall could be insulated.', 3, 8, false),
(6, '2017-09-30 17:55:00',TRUE,'Friendly and helpful staff. Great pool. Not in the city centre of SBA but close to the undergound station.', 4, 9, false);

insert into comment (id, `date`, status, text, hotel_id, user_id, is_answer) values (7, '2017-04-25 07:51:47', false, 'Gooooooooooooooooooooooooooooooood.', 4, 11, false);
insert into comment (id, `date`, status, text, hotel_id, user_id, is_answer) values (8, '2017-07-26 20:32:02', false, 'Bestttttttttttttttttttttttttt', 2, 12, false);

INSERT INTO image (id, insertion_date, hotel_id, path)
VALUES
(1, '2017-10-22 15:00:00', 1, 'intercontinental.jpg'),
(2, '2017-10-22 15:00:00', 1, 'intercontinental2.jpg'),
(3, '2017-10-22 15:00:00', 1, 'intercontinental3.jpg'),
(4, '2017-10-22 15:00:00', 2, 'tryp.jpg'),
(5, '2017-10-22 15:00:00', 2, 'tryp2.jpg'),
(6, '2017-10-22 15:00:00', 3, 'inn.jpg'),
(7, '2017-10-22 15:00:00', 3, 'inn2.jpg'),
(8, '2017-10-22 15:00:00', 4, 'marriott.jpg'),
(9, '2017-10-22 15:00:00', 4, 'marriott2.jpg');

insert into booking (id, begin_date, end_date, state, user_id) values (1, '2017-12-03 12:00:00', '2017-12-05 12:00:00', TRUE, 15);
insert into booking (id, begin_date, end_date, state, user_id) values (2, '2017-12-04 12:00:00', '2017-12-07 12:00:00', TRUE, 9);
insert into booking (id, begin_date, end_date, state, user_id) values (3, '2017-11-29 14:00:00', '2017-12-02 11:00:00', TRUE, 3);
insert into booking (id, begin_date, end_date, state, user_id) values (4, '2017-11-27 02:16:13', '2017-11-29 05:30:55', false, 3);
insert into booking (id, begin_date, end_date, state, user_id) values (5, '2017-12-05 16:53:12', '2017-12-07 14:04:27', false, 6);
insert into booking (id, begin_date, end_date, state, user_id) values (6, '2017-12-21 15:43:32', '2017-12-23 21:49:40', false, 8);
insert into booking (id, begin_date, end_date, state, user_id) values (7, '2017-11-23 20:22:39', '2017-11-24 16:22:16', true, 9);
insert into booking (id, begin_date, end_date, state, user_id) values (8, '2017-12-01 08:12:25', '2017-12-03 05:40:48', true, 11);
insert into booking (id, begin_date, end_date, state, user_id) values (9, '2017-12-23 08:48:20', '2017-12-25 10:16:14', false, 4);
insert into booking (id, begin_date, end_date, state, user_id) values (10, '2017-11-27 01:27:44', '2017-11-28 05:31:19', false, 3);
insert into booking (id, begin_date, end_date, state, user_id) values (11, '2017-12-05 09:44:00', '2017-12-09 00:10:38', true, 12);
insert into booking (id, begin_date, end_date, state, user_id) values (12, '2017-11-30 21:35:09', '2017-12-04 10:18:16', true, 13);
insert into booking (id, begin_date, end_date, state, user_id) values (13, '2017-11-28 20:26:30', '2017-12-01 05:10:56', true, 14);
